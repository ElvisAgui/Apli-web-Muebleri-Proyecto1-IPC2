<%-- 
    Document   : Sala-Venta
    Created on : 22/08/2021, 17:13:30
    Author     : elvis_agui
--%>
    ...
    <body>
        ...
        <div class="d-flex"> 
            <div class="card-body" style="background-color:#20c997 ">
                <h3 class="text-center">REGISTRA TUS MUEBLES ENSAMBLADOS A LA SALA DE VENTAS</h3>
            </div>
                ...
                <table border="10" class="table table-success table-striped">
                    <thead>
                        <tr class="table-danger">
                            ...
                            <th>Registrar en Sala</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="lista" items="${listaParaVenta}">
                            <tr>
                                <td>${lista.getId()}</td>
                                ...
                                <td>
                                    <a class="btn btn-info" href="Controlador?menu=Registro&accion=resigstroSala&ensala=${lista.getId()}">Registrar</a>
