<%-- 
    Document   : Reporte-Ganancia
    Created on : 5/09/2021, 19:43:34
    Author     : elvis_agui
--%>
    ...
    <body>
        <div class="d-flex"> 
            <div class="card-body" style="background-color:#20c997 ">
                <h3 class="text-center">REPORTE DE GANANCIA</h3>
            </div>
        </div>
        <div class="card-body" style="background-color:activecaption ">
            <div class="card-body"> 
                <div class="card-body"> 
                    <form action="Controlador?menu=Rganancia" method="POST">
            ...
            <div class="card-body"> 
                <form action="Ganancia" method="POST">
