<%-- 
    Document   : Mueble-MenosV
    Created on : 6/09/2021, 00:22:46
    Author     : elvis_agui
--%>
    ...
    <body>
        <div class="d-flex"> 
            <div class="card-body" style="background-color:#20c997 ">
                <h3 class="text-center">REPORTE DE MUEBLE MENOS VENDIDO</h3>
            </div>
        </div>
        <div class="card-body" style="background-color:activecaption ">
            <div class="card-body"> 
                <div class="card-body"> 
                    <form action="Controlador?menu=RMuebleP" method="POST">
                ...
                <br>
                <br>
                <h2>Mueble Menos Vendido--------> ${mueble}</h2>
            ...
            <div class="card-body"> 
                <form action="MenosV" method="POST">
