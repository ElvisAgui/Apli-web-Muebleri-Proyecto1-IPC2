<%-- 
    Document   : Reporte-Genera-Mas-G
    Created on : 6/09/2021, 11:41:31
    Author     : elvis_agui
--%>
    ...
    <body>
        <div class="d-flex"> 
            <div class="card-body" style="background-color:#20c997 ">
                <h3 class="text-center">REPORTE USUARIO MAYOR GANANCIA </h3>
            </div>
        </div>
        <div class="card-body" style="background-color:activecaption ">
            <div class="card-body"> 
                <div class="card-body"> 
                    <form action="Controlador?menu=RgananciaV" method="POST">
                        ...
                        <input type="submit" name="accion" value="ganancia" class="btn btn-info">
                    </form>
                </div>
                <br>
                <br>
                <h2>GANANCIA TOTAL--------> ${total}         USUARIO----> ${usuario}</h2>
            ...
            <div class="card-body"> 
                <form action="GananciaUsuario" method="POST">
                    <input type="hidden" name="Tganancia" value="${total}">
